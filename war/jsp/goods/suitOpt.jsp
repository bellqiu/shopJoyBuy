				...
				<div class="measure_content">
					<ul class="img_opt eight_img_item">
							...
							<li>
								...
								<h3 value="Burgundy" target="JACKET_LINING" checkableGroup="JACKET_LINING">Burgundy</h3>
							</li>
							<li>
								...
								<h3 value="Dark Gray" target="JACKET_LINING" checkableGroup="JACKET_LINING">Dark Gray</h3>
							</li>
							<li>
								...
								<h3 value="Dark Purple" target="JACKET_LINING" checkableGroup="JACKET_LINING">Dark Purple</h3>
							</li>
							<li>
							...
							<li>
								...
								<h3 value="Gray" target="JACKET_LINING" checkableGroup="JACKET_LINING">Gray</h3>
							</li>
							<li>
								...
								<h3 value="Navy Blue" target="JACKET_LINING" checkableGroup="JACKET_LINING">Navy Blue</h3>
							</li>
							<li>
								...
								<h3 value="Olive Green" target="JACKET_LINING" checkableGroup="JACKET_LINING">Olive Green</h3>
							</li>
							<li>
								<img class="small" src="/style/image/materials/pink.png" value="Pink" target="JACKET_LINING" checkableGroup="JACKET_LINING">
								<h3 value="Pink" target="JACKET_LINING" checkableGroup="JACKET_LINING">Pink</h3>
							</li>
							<li>
								<img class="small" src="/style/image/materials/red.jpg" value="Red" target="JACKET_LINING" checkableGroup="JACKET_LINING">
								<h3 value="Red" target="JACKET_LINING" checkableGroup="JACKET_LINING">Red</h3>
							</li>
							<li>
