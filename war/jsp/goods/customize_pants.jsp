			...
			<div id="custom2">
				...
				<div class="right_box">
					<table>
						...
						<tr>
							<td class="custItem">A Waist:</td>
							<td><input id="Customszie1" name="Waist Size"
						...
						<tr>
							<td class="custItem">B Hip:</td>
							<td><input id="Customszie2" name="Hip Size"
						...
						<tr>
							<td class="custItem">C Outseam:</td>
							<td><input id="Customszie3" name="Outseam Length"
						...
						<tr>
							<td class="custItem">D Inseam:</td>
							<td><input id="Customszie4" name="Inseam Length"
