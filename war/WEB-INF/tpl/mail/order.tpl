...
cellspacing:0in;border:none;
     ...
     <tbody><tr style="mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes">
      ...
      time, we will begin to process <a href="http://www.honeybuy.com/uc/orderDetails?id=${order.name}">your 
...
<!-- FAQ eof -->
  ...
  <tr>
    <td>Join Honeybuy Community for Coupons, Gifts and Happiness:Like Honeybuy on Facebook</td>
  </tr>
   <tr><td>&nbsp;</td>
  </tr>
</table>
